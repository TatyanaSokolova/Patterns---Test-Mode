...
class AuthTest {
    ...
    void shouldSuccessfulLoginIfRegisteredActiveUser() {
        ...
        $(".heading").shouldHave(text("Личный кабинет"), Duration.ofSeconds(15)).shouldBe(visible);
    }
    ...
    void shouldGetErrorIfNotRegisteredUser() {
        ...
        $("[data-test-id='action-login'] .button__text").click();
        $("[data-test-id='error-notification']").shouldHave(text("Ошибка! " + "Неверно указан логин или пароль"), Duration.ofSeconds(15)).shouldBe(visible);
    }
    ...
    void shouldGetErrorIfBlockedUser() {
        ...
        $("[data-test-id='action-login'] .button__text").click();
        $("[data-test-id='error-notification']").shouldHave(text("Ошибка! " + "Пользователь заблокирован"), Duration.ofSeconds(15)).shouldBe(visible);
    }
